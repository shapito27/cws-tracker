...
- Do not invent numeric ranking weights for review signals.`,Se=`You are a Chrome Web Store ASO (App Store Optimization) analyst specializing in keyword ranking diagnostics.
...
Provide 3-6 recommendations sorted by priority (high first). Every suggestion must reference actual data from the input — never give advice that could apply to any extension generically.`+D,Te=`Analyze why the competitor extension ranks higher for the keyword "{{keyword}}".
...
{{reviewSignals}}`,Ce=`You are a Chrome Web Store ASO (App Store Optimization) analyst specializing in keyword ranking diagnostics.
...
}`+D,Ae=`Analyze why the competitor extension ranks higher for the keyword "{{keyword}}".
...
{{reviewSignals}}`,xe=`You are a Chrome Web Store ASO (App Store Optimization) analyst specializing in keyword ranking diagnostics.
...
Provide 3-6 recommendations sorted by priority (high first). Focus on factors with the largest score gaps — those offer the biggest ranking improvement opportunity.`+D,be=`Analyze why the competitor extension ranks higher for the keyword "{{keyword}}".
